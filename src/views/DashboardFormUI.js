...
export default (bill) => {
  ...
  if (bill.fileUrl == null) {
    bill.fileName = "Unamed.jpg"
    bill.fileUrl = "https://firebasestorage.googleapis.com/v0/b/billable-677b6.appspot.com/o/justificatifs%2Funnamed.jpg?alt=media&token=5de56d8e-7859-4701-9f7f-d879fd5441f6"
  }
